...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='c-menu__logo']");
    private final By headerMenuOpen = By.xpath("//button[@class='menuBtn c-menu__btn']");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='c-menu__link'])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='c-menu__link'])[2]");
